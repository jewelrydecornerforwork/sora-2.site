    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-400">Start creating amazing videos with AI</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-gray-600 bg-gray-900/50 text-purple-600 focus:ring-purple-500 focus:ring-offset-gray-800"
              />
